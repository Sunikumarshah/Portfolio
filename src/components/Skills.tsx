...
import { Code, Database, Globe, Users, Cloud, Settings, Zap, Target, Heart } from 'lucide-react';
...
const Skills = () => {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Django REST Framework', level: 85, color: 'from-green-500 to-blue-500' },
    ...
    },
    {
      ...
      skills: [
        { name: 'Leadership', level: 92, color: 'from-purple-500 to-indigo-500' },
  ...
  return (
    <section id="skills" className="py-20 bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 relative overflow-hidden" ref={sectionRef}>
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-xl text-gray-400 mt-6 max-w-2xl mx-auto transition-all duration-1000 delay-300 ${
        ...
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 transition-all duration-1000 delay-500 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 text-center hover:border-purple-500/50 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-3xl font-bold text-white mb-1">{getTotalSkills()}</div>
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 text-center hover:border-purple-500/50 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-3xl font-bold text-white mb-1">{getAverageLevel()}%</div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${category.color} rounded-3xl blur-xl opacity-20 transition-opacity duration-500 ${
              ...
              <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50 hover:border-purple-500/30 transition-all duration-500 h-full">
                ...
                <div className="flex items-center space-x-4 mb-8">
                  <div className={`w-16 h-16 bg-gradient-to-br ${category.color} rounded-2xl flex items-center justify-center transform transition-transform duration-300 ${
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-sm">{category.skills.length} skills</div>
                  </div>
                </div>
                ...
                {activeCategory === categoryIndex && (
                  <div className="absolute top-4 right-4">
                    <div className="px-3 py-1 bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-purple-300 rounded-full text-sm border border-purple-500/30" style={{ animation: 'float 2s ease-in-out infinite' }}>
                      Featured
                    </div>
                  </div>
                )}
        ...
        <div className={`mt-16 text-center transition-all duration-1000 delay-1000 ${
          ...
          <div className="inline-flex items-center space-x-6 bg-gray-900/50 backdrop-blur-sm px-8 py-6 rounded-2xl border border-gray-700/50">
            <div className="flex items-center space-x-3">
              <div className="w-3 h-3 bg-green-400 rounded-full" style={{ animation: 'float 1s ease-in-out infinite' }} />
